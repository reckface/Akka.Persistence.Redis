...
namespace CustomSerialization.Protobuf
{
    ...
    class Program
    {
        ...
        private static Config config = ConfigurationFactory.ParseString(@"
            ...
            akka.actor.serializers.redis-proto = ""CustomSerialization.Protobuf.Serialization.ProtobufSerializer, CustomSerialization.Protobuf""
            akka.actor.serialization-bindings.""Akka.Persistence.IPersistentRepresentation, Akka.Persistence"" = redis-proto
            akka.actor.serialization-bindings.""CustomSerialization.Protobuf.Stored, CustomSerialization.Protobuf"" = redis-proto");
